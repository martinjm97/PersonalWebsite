  ...
  public render() {
    return (
      <div className="Page">
        ...
        <p className="projectText"> Ennui is a drag-and-drop user-interface designed for building and experimenting with neural network architectures. It provides real-time visualizations as the network is training, has detailed descriptions of various properties of deep neural networks, and has handy features like automatic code generation and link sharing (<a href="https://math.mit.edu/ennui/">Website</a>).
        <br></br><br></br>
        ...
        <p className="projectText"> Tap is a typed modernization of Python's argparse library. Tap provides the following benefits: static type checking, code completion, and source code navigation. It also includes useful experiment-tracking features (<a href="https://github.com/swansonk14/typed-argument-parser">GitHub</a>).
        </p>
        <br></br><br></br>

        <h2 className="projectTitle"> Pixelator</h2>
        <img src={require('../images/pixelator.png')} className="projectImg" />
        <p className="projectText"> We designed an algorithm that sharpens blurry images using a nonlinear machine learning free approach. We used it to enhance low-resolution images and found that it improved IBM Watson's classification accuracy for people.
